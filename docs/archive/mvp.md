...
6. archiwum `storage/offers/...`,
7. lokalny cache obrazow,
8. dashboard ofert, sekcja ostatnio zaciagnietych i klikany szczegol oferty,
9. filtry ofertowe oraz reczny shortlist,
10. zakladka mapy z naniesionymi ofertami po geokodzie,
11. ustawienia rodziny: miejsca pracy oraz wagi ocen,
12. tabela ocen mieszkania (funkcja historyczna, wycofana z interfejsu), pozioma i na suwakach,
13. ranking ofert liczony z wag i ocen,
14. pierwsza warstwa importu RCN,
15. udostepnienie aplikacji w LAN.
